...
$(document).ready(function() {
  function makeTimer() {
    var endTime = new Date("june 5, 2022 1:00:00");
    var endTime = (Date.parse(endTime)) / 1000;
    var now = new Date();
    var now = (Date.parse(now) / 1000);
    var same = Date.now()/1000;
    var timeLeft = 1654362000 - same;
...
$(document).ready(function () {
    function makeTimer() {
        var endTime = new Date("june 18, 2022 06:10:28");
        var endTime = (Date.parse(endTime)) / 1000;
        var now = new Date();
        var now = (Date.parse(now) / 1000);
...
$(document).ready(function () {
    function makeTimer() {
        var endTime = new Date("june 21, 2022 09:18:23");
        var endTime = (Date.parse(endTime)) / 1000;
        var now = new Date();
        var now = (Date.parse(now) / 1000);
        var timeLeft = endTime - now;
...
$(document).ready(function () {
  function makeTimer() {
      var endTime = new Date("june 22, 2022 07:13:18");
      var endTime = (Date.parse(endTime)) / 1000;
      var now = new Date();
      var now = (Date.parse(now) / 1000);
      var timeLeft = endTime - now;
...
$(document).ready(function () {
  function makeTimer() {
      var endTime = new Date("june 20, 2022 11:35:47");
      var endTime = (Date.parse(endTime)) / 1000;
      var now = new Date();
      var now = (Date.parse(now) / 1000);
      var timeLeft = endTime - now;
